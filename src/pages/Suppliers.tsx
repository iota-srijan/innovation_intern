...
const initialSuppliers = [
  {
    ...
    contact: { name: "Sarah Jenkins", email: "sarah@techcorp.com", phone: "+1 (555) 123-4567" },
    location: "San Jose, CA",
    status: "Active",
    fulfillmentScore: 98,
    leadTime: "3-5 days",
    lastOrder: "May 12, 2026",
  },
  {
    id: "SUP-002",
    name: "Global Logistics Ltd",
    contact: { name: "David Chen", email: "d.chen@globallogistics.net", phone: "+1 (555) 987-6543" },
    location: "Seattle, WA",
    status: "Warning",
    fulfillmentScore: 82,
    leadTime: "7-10 days",
  ...
  },
  {
    ...
    contact: { name: "Michael Ross", email: "mross@apexmanuf.co", phone: "+1 (555) 456-7890" },
    location: "Austin, TX",
    status: "Active",
    fulfillmentScore: 95,
    leadTime: "2-4 days",
    lastOrder: "May 18, 2026",
  },
  {
    id: "SUP-004",
    name: "Prime Packaging",
    contact: { name: "Elena Rodriguez", email: "elena.r@primepack.com", phone: "+1 (555) 234-5678" },
    location: "Chicago, IL",
    status: "Inactive",
    fulfillmentScore: 0,
    leadTime: "N/A",
